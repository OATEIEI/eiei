...
<div class="container mt-5">
    <div class="card">
        ...
        <div class="card-body">
            <a href="add_product.php" class="btn btn-outline-danger mb-3"><i class="bi bi-person-plus-fill"></i>เพิ่มข้อมูลสินค้า</a>
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    ?></td>
                    <td>
                        <a href="edit_product.php?pro_id=<?php echo $row['pro_id']?>">เเก้ไข</a>
                        <a href="del_product.php?pro_id=<?php echo $row['pro_id']?>" onclick="return confirm('ยืนยันการลบ?')">ลบ</a> 
                    </td>
                </tr>
                <?php }?>
            </table>
